...
2. Install the [Ainotate Claude Code plugin](https://github.com/backnotprop/ainotate):
   ```
   /install-plugin backnotprop/ainotate
   ```
...
- [Ainotate](https://github.com/backnotprop/ainotate) Claude Code plugin installed
- VS Code 1.85.0+
